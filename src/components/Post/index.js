                        ...
                        (this.props.postCreator_id !== this.props.associate_id) ?
                            <TouchableWithoutFeedback activeOpacity={0.8} style={styles.footerConetntView} onPress={() => {this.setState({ addonVisible: !this.state.addonVisible });this.addonButtonRef.current.bounceIn(800)} }>
                                <Animatable.View useNativeDriver ref={this.addonButtonRef} style={styles.footerConetntView}>
                                    <Icon name='md-add' type={'Ionicons'} style={this.state.addonVisible ? { color: '#9871d5', fontSize: 19 } : { color: '#bababa', fontSize: 19 }} />
                ...
                {this.state.addonVisible ?
                    <Animatable.View animation='zoomIn' useNativeDriver>
                        ...
                        <View style={styles.pointButtonView}>
                            <TouchableOpacity activeOpacity={0.5} underlayColor='#9871d5' style={styles.pointsView} onPress={async () => { await this.setState({ addOn: "1" }, () => this.rewardsAddon()) }}>
                                <Text style={styles.points}>+1</Text>
                            </TouchableOpacity>
                            <TouchableOpacity activeOpacity={0.5} underlayColor='#9871d5' style={styles.pointsView} onPress={async () => { await this.setState({ addOn: "5" }, () => this.rewardsAddon()) }}>
                                <Text style={styles.points}>+5</Text>
                            </TouchableOpacity>
                            <TouchableOpacity activeOpacity={0.5} underlayColor='#9871d5' style={styles.pointsView} onPress={async () => { await this.setState({ addOn: "10" }, () => this.rewardsAddon()) }}>
